...
public class Productos {
	...
	public Productos(int codigo, String nombre, UnidadesMedida udm, BigDecimal precioVenta, boolean tieneIva,
	...
	public String toString() {
		return "Productos [codigo=" + codigo + ", nombre=" + nombre + ", udm=" + udm + ", precioVenta=" + precioVenta
